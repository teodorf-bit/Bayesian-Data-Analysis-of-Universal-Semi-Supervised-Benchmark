...
dataset%>% 
  ...
  kable(
        "latex", 
        table.envir = 'table',
        caption='Summary statistics for the error rate (small allocation of labels)', 
        booktabs=T,
...
dataset %>% 
  ...
  kable(
        "latex", 
        table.envir = 'table',
        caption='Summary statistics for the error_rate (small allocation of labels)', 
        booktabs=T,
        label='summarystatisticstable-small',
        format.args = list(scientific = FALSE), 
        digits = 3,
...
summary_ranking.fit <- ranking.fit$summary(variables = a_alg) %>%
  ...
  kable(
      "latex", 
      table.envir = 'table',
      caption='Diagnostics for the posterior ranks (small allocation of labels)', 
      booktabs=T,
...
rank_df_table %>% 
  kable(
      "latex", 
      table.envir = 'table',
      caption='Ranking of the algorithms (small allocation of labeled data)', 
      booktabs=T,
      label='rankingsmall',
      format.args = list(scientific = FALSE), 
      digits = 3,
